...
class LeftPanel extends StatelessWidget {
  ...
  Widget featureCard(IconData icon, String title, {required bool mobile}) {
    return Column(
      ...
      children: [
        Container(
          ...
          child: Icon(icon, color: Colors.white, size: mobile ? 23 : 28),
        ),
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  featureCard(Icons.security_rounded, "Secure", mobile: mobile),
                  featureCard(
