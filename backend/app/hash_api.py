...
app = FastAPI(
    title="Digital Evidence Security & Reporting Module (Member 5)",
    description=(
        "Production-grade Security, Cryptographic Integrity, Chain of Custody, "
        "Timeline Reconstruction, and PDF Reporting Module for Digital Evidence Prioritization System."
    ),
    version="2.0.0",
    lifespan=lifespan
)
...
# Register all Member 5 route modules
