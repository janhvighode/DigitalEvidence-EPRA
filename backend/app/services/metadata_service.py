...
from app.services.backend_adapter import get_backend_adapter, EvidenceItem, map_backend_verification_status
...
class MetadataService:
    ...
    def get_metadata_table(
        ...
        for idx, r in enumerate(records, start=offset + 1):
            ...
            items.append({
                ...
                "preview_url": f"/evidence/{ev_id}/preview" if is_previewable else None,
                "download_url": f"/evidence/{ev_id}/download",
                "details_url": f"/evidence/{ev_id}/details"
            })
    ...
    @staticmethod
    def get_file_details(db: Session, evidence_id: str) -> Dict[str, Any]:
        """
        ...
        return {
            ...
            "download_url": f"/evidence/{record.external_evidence_id or record.id}/download",
            "preview_url": f"/evidence/{record.external_evidence_id or record.id}/preview" if is_image else None
        }
